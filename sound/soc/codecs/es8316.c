...
static int es8316_resume0(struct snd_soc_component *component)
{
	
	snd_soc_component_write(component,0x00,0xc0);
	snd_soc_component_write(component,0x01,0x77);
	snd_soc_component_write(component,0x02,0x08);
	snd_soc_component_write(component,0x03,0x20);
	snd_soc_component_write(component,0x04,0x11);
	snd_soc_component_write(component,0x05,0x00);
	snd_soc_component_write(component,0x06,0x11);
	snd_soc_component_write(component,0x07,0x00);
	snd_soc_component_write(component,0x08,0x00);
	snd_soc_component_write(component,0x09,0x04);
	snd_soc_component_write(component,0x0a,0x00);
	snd_soc_component_write(component,0x0b,0x0c);
	snd_soc_component_write(component,0x0c,0xff);
//	snd_soc_component_write(component,0x0d,0x00);
	snd_soc_component_write(component,0x0e,0x3f);
	snd_soc_component_write(component,0x0f,0x1f);
	snd_soc_component_write(component,0x10,0x11);
	snd_soc_component_write(component,0x11,0xfc);
	snd_soc_component_write(component,0x12,0x28);
	...
	snd_soc_component_write(component,0x1b,0x30);
	snd_soc_component_write(component,0x1c,0x0f);
	snd_soc_component_write(component,0x1d,0x00);
	snd_soc_component_write(component,0x1e,0x90);
	snd_soc_component_write(component,0x1f,0x90);
	snd_soc_component_write(component,0x20,0x00);
	snd_soc_component_write(component,0x21,0x00);
	snd_soc_component_write(component,0x22,0xc0);
	snd_soc_component_write(component,0x23,0x60);
	snd_soc_component_write(component,0x24,0x01);
	snd_soc_component_write(component,0x25,0x08);
	snd_soc_component_write(component,0x26,0x10);
	snd_soc_component_write(component,0x27,0x00);
	snd_soc_component_write(component,0x28,0x00);
	...
	snd_soc_component_write(component,0x2c,0x05);
	snd_soc_component_write(component,0x2d,0x06);
	snd_soc_component_write(component,0x2e,0x61);
	snd_soc_component_write(component,0x2f,0x00);
	snd_soc_component_write(component,0x30,0x00);
	snd_soc_component_write(component,0x31,0x20);
	...
	snd_soc_component_write(component,0x35,0x1f);
	snd_soc_component_write(component,0x36,0xf7);
	snd_soc_component_write(component,0x37,0xfd);
	snd_soc_component_write(component,0x38,0xff);
	snd_soc_component_write(component,0x39,0x1f);
	snd_soc_component_write(component,0x3a,0xf7);
	snd_soc_component_write(component,0x3b,0xfd);
	snd_soc_component_write(component,0x3c,0xff);
	snd_soc_component_write(component,0x3d,0x1f);
	snd_soc_component_write(component,0x3e,0xf7);
	snd_soc_component_write(component,0x3f,0xfd);
	snd_soc_component_write(component,0x40,0xff);
	snd_soc_component_write(component,0x41,0x1f);
	snd_soc_component_write(component,0x42,0xf7);
	snd_soc_component_write(component,0x43,0xfd);
	snd_soc_component_write(component,0x44,0xff);
	snd_soc_component_write(component,0x45,0x1f);
	snd_soc_component_write(component,0x46,0xf7);
	snd_soc_component_write(component,0x47,0xfd);
	snd_soc_component_write(component,0x48,0xff);
	snd_soc_component_write(component,0x49,0x1f);
	snd_soc_component_write(component,0x4a,0xf7);
	snd_soc_component_write(component,0x4b,0xfd);
	snd_soc_component_write(component,0x4c,0xff);
	snd_soc_component_write(component,0x4d,0x00);
	snd_soc_component_write(component,0x4e,0xf3);
	snd_soc_component_write(component,0x4f,0xff);
	snd_soc_component_write(component,0x50,0xa0);
	snd_soc_component_write(component,0x51,0x00);
	snd_soc_component_write(component,0x52,0x00);
	snd_soc_component_write(component,0x53,0x00);
	return 0;
}
			      ...
			      struct snd_soc_dai *dai)
{
	...
	power2 = snd_soc_component_read32(component, ES8316_CPHP_PDN2_REG1A);
	if(power2==0x22)
	{
		es8316_resume(component);
		es8316_resume0(component);
	}
...
static int es8316_init_regs(struct snd_soc_component *component)
{
	...
	snd_soc_component_write(component,ES8316_DAC_VOLL_REG33, 0x08);
	snd_soc_component_write(component,ES8316_DAC_VOLR_REG34, 0x06);
...
struct snd_soc_component *component_g;
...
int es8316_headset_detect(int jack_insert)
{
	...
	es8316 = snd_soc_component_get_drvdata(component_g);
	...
	if (jack_insert) {
		snd_soc_component_update_bits(component_g,
			    ...
			    const struct i2c_device_id *id)
{
	...
	if (es8316->hp_det_gpio < 0) {
		...
		ret = devm_request_threaded_irq(&i2c_client->dev, hp_irq, NULL,
						es8316_irq_handler,
		...
		if (ret < 0) {
			dev_err(&i2c_client->dev, "request_irq failed: %d\n", ret);
			return ret;
		}
...
static void es8316_i2c_shutdown(struct i2c_client *client)
{
	struct es8316_priv *es8316 = i2c_get_clientdata(client);
		...
		es8316_enable_spk(es8316, false);
		msleep(20);
		es8316_set_bias_level(component_g, SND_SOC_BIAS_OFF);
